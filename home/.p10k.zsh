# Generated by Powerlevel10k configuration wizard on 2019-12-06 at 00:27 GMT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 47607.
...
#      status                  # exit code of the last command
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%015F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%015F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%015F─╯'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=84
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=126
